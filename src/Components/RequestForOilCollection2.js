...
import Okay from "../Images/Okay.webp"
import ErrorGif from "../Images/error.webp"
         ...
         <div className='row' >
                                <div className='col-lg-12'>
                                    <div className="mb-3 text-left">
                                        <label className='lable mb-2'>Firm Name* </label>
                                        <input type="text"
                                ...
                                <div className='col-lg-6'>
                                    <div className="mb-3 text-left">
                                        <label className='lable mb-2'>Your Name *</label>
                                        <input type="text"
                                            className="form-control p-3"
                                ...
                                <div className='col-lg-6'>
                                    <div className="mb-3 text-left">
                                        <label className='lable mb-2'> Phone Number * </label>
                                        <input type="text"
                                            className="form-control p-3"
                                ...
                                <div className='col-lg-6'>
                                    <div className="mb-3 text-left">
                                        <label className='lable mb-2'> Oil Quantity* (KG) </label>
                                        <input type="number"
                                            className="form-control p-3"
                                ...
                                <div className='col-lg-6'>
                                    <div className="mb-3 text-left">
                                        <label className='lable mb-2'>Expected Rate* (₹/KG)</label>
                                        <input type="number"
                                            className="form-control p-3"
                                ...
                                <div className='col-lg-6'>
                                    <div className="mb-3 text-left">
                                        <label className='lable mb-2'>Expected Date to start*</label>
                                        <input type="date"
                                            className="form-control p-3"
                                            placeholder=""
                                ...
                                <div className='col-lg-6'>
                                    <div className="mb-3 text-left">
                                        <label className='lable mb-2'> Address* </label>
                                        <input type="text"
                                            className="form-control p-3"
                                            placeholder="Address"
                                ...
                                <div className='col-lg-6'>
                                    <div className="mb-3 text-left">
                                        <label className='lable mb-2'>Postal Code*</label>
                                        <input type="text"
                                            className="form-control p-3"
                                ...
                                <div className='col-lg-12'>
                                    <div className="mb-3 text-left">
                                        <label className='lable mb-2'>Remarks</label>
                                        <textarea type="text"
                                            className="form-control p-3"
                                            placeholder="Remarks"
                                            row={6}
